...
function lagKontrollsak(overstyringer: Partial<KontrollsakResponse> = {}): KontrollsakResponse {
  return {
    ...
    saksbehandlere: {
      eier: null,
      deltMed: [],
      opprettetAv: { navIdent: "Z123456", navn: "Seksjon A" },
    },
    status: "UFORDELT",
    kategori: "UDEFINERT",
    kilde: "INTERN",
...
describe("beregnBehandlingstid", () => {
  ...
  test("beregner behandlingstid for avsluttede saker", () => {
    const saker = [
      lagKontrollsak({ id: "1", status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
    ];
    const avslutningsdatoer: Avslutningsdatoer = {
...
describe("beregnAntallPerSeksjon", () => {
  test("grupperer riktig etter opprettet av og sorterer synkende", () => {
    const saker = [
      lagKontrollsak({
        id: "1",
        saksbehandlere: {
          eier: null,
          deltMed: [],
          opprettetAv: { navIdent: "A", navn: "Seksjon A" },
        },
      }),
      lagKontrollsak({
        id: "2",
      ...
      lagKontrollsak({
        ...
        saksbehandlere: {
          eier: null,
          deltMed: [],
          opprettetAv: { navIdent: "B", navn: "Seksjon B" },
        },
      }),
      lagKontrollsak({
        id: "4",
        saksbehandlere: {
          eier: null,
          deltMed: [],
          opprettetAv: { navIdent: "C", navn: "Seksjon C" },
        },
      }),
      lagKontrollsak({
        id: "5",
  ...
  test("grupperer backend-saker på opprettetAv", () => {
    const resultat = beregnAntallPerSeksjon([
      lagKontrollsak({
        ...
        saksbehandlere: {
          eier: null,
          deltMed: [],
          opprettetAv: { navIdent: "4812", navn: "4812" },
        },
      }),
      lagKontrollsak({
        id: "ks-2",
      ...
      lagKontrollsak({
        ...
        saksbehandlere: {
          eier: null,
          deltMed: [],
          opprettetAv: { navIdent: "4813", navn: "4813" },
        },
      }),
    ]);
  ...
  test("sorterer stigende etter antall ytelser", () => {
    const saker = [
      lagKontrollsak({
        id: "1",
        ytelser: [
          { id: "y1", type: "A", periodeFra: "2025-01-01", periodeTil: "2025-01-31", belop: null },
          { id: "y2", type: "B", periodeFra: "2025-01-01", periodeTil: "2025-01-31", belop: null },
          { id: "y3", type: "C", periodeFra: "2025-01-01", periodeTil: "2025-01-31", belop: null },
        ],
      }),
      lagKontrollsak({
        id: "2",
        ytelser: [
          { id: "y4", type: "A", periodeFra: "2025-01-01", periodeTil: "2025-01-31", belop: null },
        ],
      }),
    ];
