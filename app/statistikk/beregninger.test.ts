...
describe("beregnAntallPerStatus", () => {
  test("teller riktig antall per status", () => {
    const saker = [
      ...
      lagKontrollsak({ id: 104, status: "AVSLUTTET" }),
      lagKontrollsak({ id: 105, status: "AVSLUTTET" }),
    ];
  ...
  test("mapper backend-statuser direkte", () => {
    const resultat = beregnAntallPerStatus([
      lagKontrollsak({ id: 106, status: "OPPRETTET" }),
      lagKontrollsak({ id: 107, status: "UTREDES" }),
  ...
  test("teller saker i bero separat fra status", () => {
    expect(
      beregnAntallIBero([
        lagKontrollsak({ id: 109, status: "OPPRETTET", blokkert: "I_BERO" }),
        lagKontrollsak({ id: 110, status: "UTREDES", blokkert: "I_BERO" }),
        lagKontrollsak({ id: 111, status: "UTREDES" }),
      ]),
    ).toBe(2);
  });
});
...
describe("beregnBehandlingstid", () => {
  test("beregner riktig min, median, gjennomsnitt og maks", () => {
    const saker = [
      lagKontrollsak({ id: 112, status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
      lagKontrollsak({ id: 113, status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
      lagKontrollsak({ id: 114, status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
    ];
  ...
  test("beregner median for partall antall saker", () => {
    const saker = [
      lagKontrollsak({ id: 115, status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
      lagKontrollsak({ id: 116, status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
    ];
    const avslutningsdatoer: Avslutningsdatoer = {
      "115": "2025-01-11",
      "116": "2025-01-21",
  ...
  test("inkluderer avsluttede saker", () => {
    const saker = [
      lagKontrollsak({ id: 117, status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
    ];
    const avslutningsdatoer: Avslutningsdatoer = {
      "117": "2025-01-15",
    };
  ...
  test("ignorerer saker som ikke er avsluttet", () => {
    const saker = [
      lagKontrollsak({ id: 118, status: "UTREDES", opprettet: "2025-01-01T00:00:00Z" }),
      lagKontrollsak({ id: 119, status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
    ];
    const avslutningsdatoer: Avslutningsdatoer = {
      "119": "2025-01-31",
    };
  ...
  test("returnerer null når ingen saker er avsluttet", () => {
    expect(beregnBehandlingstid([lagKontrollsak({ id: 120, status: "UTREDES" })], {})).toBeNull();
  });

  test("bruker backend opprettet-felt for kontrollsaker", () => {
    const saker = [
      lagKontrollsak({ id: 121, status: "AVSLUTTET", opprettet: "2025-01-01T00:00:00Z" }),
    ];
    const avslutningsdatoer: Avslutningsdatoer = {
      "121": "2025-01-11",
    };
...
describe("beregnAntallPerSeksjon", () => {
  test("grupperer riktig etter seksjon og sorterer synkende", () => {
    const saker = [
      lagKontrollsak({ id: 122, saksbehandlere: medEnhet("Seksjon A") }),
      lagKontrollsak({ id: 123, saksbehandlere: medEnhet("Seksjon A") }),
      lagKontrollsak({ id: 124, saksbehandlere: medEnhet("Seksjon B") }),
      lagKontrollsak({ id: 125, saksbehandlere: medEnhet("Seksjon C") }),
      lagKontrollsak({ id: 126, saksbehandlere: medEnhet("Seksjon C") }),
      lagKontrollsak({ id: 127, saksbehandlere: medEnhet("Seksjon C") }),
    ];
  ...
  test("grupperer backend-saker på mottaksenhet", () => {
    expect(
      beregnAntallPerSeksjon([
        lagKontrollsak({ id: 128, saksbehandlere: medEnhet("4812") }),
        lagKontrollsak({ id: 129, saksbehandlere: medEnhet("4812") }),
        lagKontrollsak({ id: 130, saksbehandlere: medEnhet("4813") }),
      ]),
    ).toEqual([
      { navn: "4812", antall: 2 },
      { navn: "4813", antall: 1 },
...
describe("beregnFordelingPerYtelse", () => {
  test("teller ytelser på tvers av saker", () => {
    const saker = [
      lagKontrollsak({ id: 201, ytelser: [lagYtelse("y1", "Dagpenger")] }),
      lagKontrollsak({
        id: 131,
        ytelser: [lagYtelse("y2", "Dagpenger"), lagYtelse("y3", "Sykepenger")],
      }),
      lagKontrollsak({ id: 202, ytelser: [lagYtelse("y4", "Sykepenger")] }),
    ];
  ...
  test("sorterer synkende etter antall", () => {
    const saker = [
      lagKontrollsak({ id: 203, ytelser: [lagYtelse("y1", "Dagpenger")] }),
      lagKontrollsak({ id: 204, ytelser: [lagYtelse("y2", "Sykepenger")] }),
      lagKontrollsak({ id: 205, ytelser: [lagYtelse("y3", "Sykepenger")] }),
      lagKontrollsak({ id: 206, ytelser: [lagYtelse("y4", "Sykepenger")] }),
    ];
  ...
  test("teller backend-ytelser fra objekter", () => {
    const resultat = beregnFordelingPerYtelse([
      lagKontrollsak({ id: 207, ytelser: [lagYtelse("y1", "Dagpenger")] }),
      lagKontrollsak({ id: 208, ytelser: [lagYtelse("y2", "Sykepenger")] }),
      lagKontrollsak({ id: 209, ytelser: [lagYtelse("y3", "Sykepenger")] }),
    ]);
...
describe("beregnFordelingPerAntallYtelser", () => {
  test("grupperer saker etter antall ytelser", () => {
    const saker = [
      lagKontrollsak({ id: 210, ytelser: [lagYtelse("y1", "Dagpenger")] }),
      lagKontrollsak({ id: 211, ytelser: [lagYtelse("y2", "Dagpenger")] }),
      lagKontrollsak({
        id: 132,
  ...
  test("sorterer stigende etter antall ytelser", () => {
    const saker = [
      ...
      lagKontrollsak({ id: 212, ytelser: [lagYtelse("y4", "A")] }),
    ];
  ...
  test("grupperer backend-saker etter antall ytelsesobjekter", () => {
    expect(
      beregnFordelingPerAntallYtelser([
        lagKontrollsak({ id: 213, ytelser: [lagYtelse("y1", "Dagpenger")] }),
        lagKontrollsak({
          id: 135,
          ytelser: [lagYtelse("y2", "Dagpenger"), lagYtelse("y3", "Sykepenger")],
        }),
