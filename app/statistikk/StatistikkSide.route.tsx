      ...
      <PageBlock width="lg" gutters>
        <VStack gap="space-8" className="mt-4 mb-8">
          ...
          {behandlingstid && (
            <section aria-labelledby="behandlingstid-heading">
              ...
              <HGrid columns={{ xs: 2, md: 4 }} gap="space-4">
                ...
                <NøkkeltallKort tittel="Gjennomsnitt" verdi={behandlingstid.gjennomsnitt} enhet="dager" />
          ...
          <section aria-labelledby="antall-ytelser-heading">
            ...
            <FordelingTabell
              rader={fordelingPerAntallYtelser}
              totalt={totaltAntall}
            />
          </section>
        </VStack>
...
function FordelingTabell({
  rader,
  totalt,
}: {
  rader: GruppertAntall[];
  totalt?: number;
}) {
