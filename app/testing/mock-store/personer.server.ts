 ...
 * ident (f.eks. etter kjønnsskifte eller feilregistrering) resolves til personens
...
/** Resolver en (eventuelt historisk) ident til gjeldende ident. Uendret hvis ikke historisk. */
