...
export const mockKodeverk: Kodeverk = {
  ...
  enheter: [
    { kode: "ky153k", beskrivelse: "Kontroll Øst" },
    { kode: "gu301n", beskrivelse: "Kontroll Vest" },
    { kode: "hu424t", beskrivelse: "Kontroll Nord" },
    { kode: "by295h", beskrivelse: "Kontroll Analyse" },
  ],
};
