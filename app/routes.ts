...
export default [
  ...
  layout("layout/AppLayout.tsx", [
    ...
    route(RouteConfig.MIGRERING, "migrering/MigreringSide.route.tsx"),
  ...
  route(
    RouteConfig.API.SAK_DOKUMENT_KOMMENTARER,
    "saker/filer/dokument/kommentarer/kommentarer.api.ts",
  ),
