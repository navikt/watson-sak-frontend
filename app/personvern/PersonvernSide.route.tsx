  ...
  return (
    <Page>
      <PageBlock width="text" gutters>
        <title>
          {`Personvern – Watson Sak ${miljø !== "prod" ? `(${miljø})` : ""}`}
        </title>
        ...
        <BodyLong spacing>
          Alle aktiviteter du foretar deg på tjenesten blir lagret i en
          audit-logg. Dette gjøres for å sikre sporbarhet av det som gjøres i
          tjenesten.
        </BodyLong>
        <BodyLong spacing>
          I tillegg til dette, lagrer vi også informasjon om hvordan du bruker
          tjenesten i tjenestene Umami. Dette gjøres for å kvantitativt
