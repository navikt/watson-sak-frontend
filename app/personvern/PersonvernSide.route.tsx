  ...
  return (
    <>
      ...
      <BodyLong size="large" spacing>
        Når du bruker tjenesten, lagrer vi informasjon om hva du foretar deg. Her kan du lese mer om
        hva som registreres, og hvordan vi bruker informasjonen.
      </BodyLong>
      <Heading level="2" size="medium" spacing>
        Hva samler vi inn?
      </Heading>
      <BodyLong spacing>
        Alle aktiviteter du foretar deg på tjenesten blir lagret i en audit-logg. Dette gjøres for å
        sikre sporbarhet av det som gjøres i tjenesten.
      </BodyLong>
      <BodyLong spacing>
        I tillegg til dette, lagrer vi også informasjon om hvordan du bruker tjenesten i tjenestene
        Umami. Dette gjøres for å kvantitativt analysere bruk av tjenesten, slik at vi kan
      ...
      <BodyLong spacing>
        Har du spørsmål om personvern eller om hvordan vi bruker informasjonen vi samler inn, kan du
        kontakte teamet på <Link href="mailto:espen.einn@nav.no">espen.einn@nav.no</Link>.
      </BodyLong>
    </>
  );
}
