...
import { formaterBlokkeringsarsak, getStatus } from "~/saker/visning";
...
export function mapKontrollsakTilSakslisteRad(
  ...
  return {
    ...
    ventestatus: sak.blokkert ? formaterBlokkeringsarsak(sak.blokkert) : null,
